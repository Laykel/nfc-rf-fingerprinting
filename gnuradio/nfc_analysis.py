...
class nfc_analysis(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("NFC Analysis")
        ...
        self.qtgui_time_sink_x_1_0.set_y_axis(-0.5, 0.5)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_1_0_win, 4, 1, 2, 1)
        for r in range(4, 6):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_1_win, 2, 1, 2, 1)
        for r in range(2, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_win, 4, 0, 2, 1)
        for r in range(4, 6):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/luc/HEIG/TB/REPO_nfc-rf-fingerprinting/data/recordings/3.0-antenna-1.nfc', True, 0, 0)
