...
class NFC_test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "NFC Test")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("NFC Test")
        ...
        self.settings = Qt.QSettings("GNU Radio", "NFC_test")
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, './nfc.bin', False)
...
def main(top_block_cls=NFC_test, options=None):
