...
class nfc_acquisition_37(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "NFC Acquisition GRC3.7")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("NFC Acquisition GRC3.7")
        ...
        self.connect((self.osmosdr_source_0, 0), (self.blocks_complex_to_mag_1, 0))
...
def main(top_block_cls=nfc_acquisition_37, options=None):
