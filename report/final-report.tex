...
\usepackage{amsmath,amsfonts,amssymb}   % Advanced math typesetting
\usepackage{graphicx}
...
\newacronym{iq}{I/Q}{Signal composed of In-phase and Quadrature components}
...
% Cover page
\include{fin-sections/coverpage}
\newpage

% Résumé publiable ============================================================================================
\include{fin-sections/summary}
\newpage

% Preamble
\include{fin-sections/preamble}
\newpage

% Official authentication
\include{fin-sections/authentication}
\newpage

% Specification (cahier des charges)
\include{int-sections/scopestatement}
\newpage
...
% Introduction
\include{fin-sections/introduction}
\newpage

% Necessary concepts
\include{fin-sections/concepts}
\newpage

% State of the art
\include{fin-sections/stateoftheart}
\newpage

% Dataset creation
\include{fin-sections/dataset}
\newpage

% Data preparation
\include{fin-sections/dataprep}
\newpage

% Machine learning models and experiences
\include{fin-sections/ml}
\newpage

\include{fin-sections/conclusion}
\newpage
